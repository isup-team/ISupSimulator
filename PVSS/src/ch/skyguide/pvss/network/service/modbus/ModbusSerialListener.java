...
public class ModbusSerialListener {
    ...
    private static final Logger LOGGER = Logger.getLogger(ModbusSerialListener.class.getName());
    //Members
    ...
    private void listen() {
        try {
            m_SerialCon.open();
            LOGGER.log(Level.INFO, "Modbus communication started !");
            ...
            do {
                if (m_Listening) {
                    try {
                        ...
                        LOGGER.log(Level.INFO, "Request : {0}", request.getHexMessage());
                        LOGGER.log(Level.INFO, "Response : {0}", response.getHexMessage());
            ...
            m_SerialCon.close();
            LOGGER.log(Level.INFO, "Modbus communication terminated !");
        } catch (Exception e) {
