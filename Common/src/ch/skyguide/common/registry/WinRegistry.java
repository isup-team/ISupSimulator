...
public class WinRegistry {
	...
	public static String readString(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPathValue p = PathDecoder.decodeKeyPathValue(completePath);
		return readString(p.getKey(), p.getPath(), p.getValueKey());
	}
	...
	public static Map<String, String> readStringValues(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPath p = PathDecoder.decodeKeyPath(completePath);
		return readStringValues(p.getKey(), p.getPath());
	}
	...
	public static List<String> readStringSubKeys(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPath p = PathDecoder.decodeKeyPath(completePath);
		return readStringSubKeys(p.getKey(), p.getPath());
	}
	...
	public static void createKey(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPath p = PathDecoder.decodeKeyPath(completePath);
		createKey(p.getKey(), p.getPath());
	}
	...
	public static void writeStringValue(String completePath, String value)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPathValue p = PathDecoder.decodeKeyPathValue(completePath);
		writeStringValue(p.getKey(), p.getPath(), p.getValueKey(), value);
	}
	...
	public static void deleteKey(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPath p = PathDecoder.decodeKeyPath(completePath);
		deleteKey(p.getKey(), p.getPath());
	}
	...
	public static void deleteValue(String completePath)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException {

		PathDecoder.KeyPathValue p = PathDecoder.decodeKeyPathValue(completePath);
		deleteValue(p.getKey(), p.getPath(), p.getValueKey());
	}
